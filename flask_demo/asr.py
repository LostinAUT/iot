...
# -------------------------------------
appid = "6228786254"    # 项目的 appid
token = "6WnF4rwIiS76sOgOHJqyfBFq1j9swTfX"    # 项目的 token
cluster = "volcengine_input_common"  # 请求的集群
audio_path = "./audio/warning.mp3"  # 本地音频路径
...
def test_one():
    ...
    input_text = result['result']['payload_msg']['result'][0]['text']
    print(input_text)
